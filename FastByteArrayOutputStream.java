...
public class FastByteArrayOutputStream extends OutputStream {
    ...
    protected final Deque<byte[]> buffers = new ArrayDeque<>();
    ...
    public FastByteArrayOutputStream(int initialBlockSize) {
        assert initialBlockSize > 0; // , "Initial block size must be greater than 0");
...
//    }
    ...
    public void resize(int targetCapacity) {
        assert targetCapacity >= size(); // , "New capacity must not be smaller than current size");
